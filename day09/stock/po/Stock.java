 ...
 */
package com.lab.ocp.day09.stock.po;
...
public class Stock {
    ...
    public Stock(String 證券代號, String 證券名稱, String 殖利率, String 股利年度, String 本利比, String 股價淨值比, String 財報年季) {
        this.證券代號 = 證券代號;
        this.證券名稱 = 證券名稱;
        this.殖利率 = 殖利率;
        this.股利年度 = 股利年度;
